...
public class JsonData {
	...
	public static int update(Map<String, String> map, String recId, int flag) {
		...
		try {
			...
			if (recId != null && flag == mm.com.Constants.UPDATE_MODE.UPDATE) {
				...
				arguments.add(new BasicNameValuePair(mm.com.Constants.UPDATE_MODE.name, ""
						+ mm.com.Constants.UPDATE_MODE.UPDATE));

				Log.w("params length:", "size:" + arguments.size());

			} else if (recId != null && flag == mm.com.Constants.UPDATE_MODE.DELETE) {

				arguments.add(new BasicNameValuePair("recordId", recId));
				arguments.add(new BasicNameValuePair(mm.com.Constants.UPDATE_MODE.name, ""
						+ mm.com.Constants.UPDATE_MODE.DELETE));

			} else {
				arguments.add(new BasicNameValuePair(mm.com.Constants.UPDATE_MODE.name, ""
						+ mm.com.Constants.UPDATE_MODE.CREATE));
