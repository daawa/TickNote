...
public class TitlesFragment extends ListFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		new mm.com.util.MyThread.QueryTitlesThread().setArgs(getActivity(), init_delete_handler).start();
		...
		lv.setOnScrollListener(new AbsListView.OnScrollListener() {
			...
			public void onScrollStateChanged(AbsListView view, int scrollState) {
				...
				if (scrollState == OnScrollListener.SCROLL_STATE_IDLE && visibleLastIndex == lastIndex) {
					...
					new mm.com.util.MyThread.QueryTitlesThread().setArgs(getActivity(), load_more_handler)
		...
		case R.id.menu_delete:
			...
			new MyThread.UpdateThread()
					.setArgs(getActivity(), init_delete_handler, String.valueOf(recordId), null,
							mm.com.Constants.UPDATE_MODE.DELETE).setPosition(mi.position).start();
	...
	Handler init_delete_handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			String init_delete = data.getString(mm.com.Constants.UPDATE_MODE.name);

			if (init_delete != null && init_delete.equals(String.valueOf(mm.com.Constants.UPDATE_MODE.DELETE))) {
